...
public class WSQMetadata extends IIOMetadata {
     ...
     */
    public WSQMetadata(final double PPI) {
        this();
     ...
     */
    public WSQMetadata(final double PPI, final double BitRate) {
        this();
        setProperty(KEY_PPI, Double.toString(PPI));
     ...
     */
    public boolean setProperty(final String key, String value) {
    ...
    public void setFromTree(final String formatName, final Node root) throws IIOInvalidTreeException {
        final Map<String, String> backup = new LinkedHashMap<String, String>(nistcom);
     ...
     */
    protected void mergeStandardCompressionNode(final Node compression) throws IIOInvalidTreeException {
     ...
     */
    protected void mergeStandardDimensionNode(final Node dimensionNode) throws IIOInvalidTreeException {
        ...
        for (Node pixelSizeNode=dimensionNode.getFirstChild(); pixelSizeNode!=null; pixelSizeNode=pixelSizeNode.getNextSibling()) {
            ...
            for (int i=0; i<pixelSizeNode.getAttributes().getLength(); i++) {
                ...
                } catch (final Throwable t) {} //Ignores NumberFormatException, will be handled bellow.
            }
            if (!(value > 0))
